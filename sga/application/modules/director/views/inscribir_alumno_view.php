<div id="agregarAlumnoInstanciaCurso" class="container-fluid" align="center">
	...
	<form method="post" action="<?=base_url()?>index.php/director/guardarNuevoAlumno">
	  <div class="row">
	    <div class="col-sm">
		...
		<div class="col-sm">
	      <div class="form-group">
		    ...
		    <select class="form-control" name="alumnosNo" id="alumnosNo">
	          <?foreach($alumnosNo as $alno):?>
	            <option value="<?=$alno->matricula?>"><?=$alno->matricula?>, <?=$alno->nombre?></option>
	          <?endforeach;?>
	        </select>
		  </div>
		</div>
